  ...
  return (
    <main className="relative min-h-svh overflow-x-hidden bg-background">
      ...
      <div className="relative mx-auto grid min-h-svh max-w-[96rem] lg:grid-cols-[1.08fr_0.92fr]">
        <section className="relative hidden min-h-svh border-e border-border/70 p-10 lg:flex xl:p-14">
          <div className="flex w-full flex-col justify-between">
            ...
            >
              ...
              <span>
                <span className="brand-wordmark block text-2xl">Synk</span>
            ...
            <div className="mx-auto w-full max-w-2xl py-14">
              ...
              <div className="relative mt-10 overflow-hidden rounded-[2rem] border border-border/80 bg-card/95 p-5 shadow-2xl shadow-black/15">
              ...
              <div className="mt-7 grid grid-cols-3 gap-3">
                <Feature
                  icon={<Clock3 />}
                  label={t("Find the time that works for everyone.")}
                />
                <Feature
                  icon={<UsersRound />}
                  label={t("No participant accounts")}
                />
                <Feature
                  icon={<CalendarCheck2 />}
                  label={t("Visual availability")}
                />
              </div>
            </div>
        ...
        <section className="relative flex min-h-svh items-center justify-center px-4 py-8 sm:px-8 lg:px-10 xl:px-16">
          <div className="w-full max-w-[31rem] rounded-[2rem] border border-border/80 bg-card/95 p-6 shadow-2xl shadow-black/30 sm:p-9">
            <Link
              aria-label={t("Synk home")}
            ...
            >
              ...
              <span className="brand-wordmark text-xl">Synk</span>
            </Link>
...
function Feature({ icon, label }: { icon: React.ReactNode; label: string }) {
  return (
    <div className="rounded-2xl border border-border/65 bg-card/75 p-3.5">
